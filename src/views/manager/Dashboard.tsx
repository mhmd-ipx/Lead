...
const guidelines = [
    {
        ...
        description: 'از پایداری و کیفیت اتصال اینترنت خود مطمئن شوید. قطع شدن ناگهانی ارتباط ممکن است روند آزمون را مختل کند.',
    },
    {
        icon: <HiOutlineShieldExclamation className="w-6 h-6" />,
        color: 'rose',
        title: 'VPN را غیرفعال کنید',
        description: 'VPN یا هر نرم‌افزار تغییر IP را غیرفعال کنید. استفاده از vpn می‌تواند موجب اختلال در ارتباط با سرور و ثبت نشدن پاسخ‌ها شود.',
    },
    {
        icon: <HiOutlineDesktopComputer className="w-6 h-6" />,
        color: 'blue',
        title: 'مرورگر و سیستم کامپیوتری مناسب',
        description: 'توصیه می‌شود آزمون را بر روی کامپیوتر یا لپ تاپ انجام دهید؛ همچنین از آخرین نسخه مرورگرهای chrome ، firefox یا edge استفاده کنید.',
    },
    {
        icon: <HiOutlineLockClosed className="w-6 h-6" />,
        color: 'amber',
        title: 'آزمون‌ها قابل ویرایش نیستند',
        description: 'پیش از تأیید نهایی، پاسخ‌های خود را با دقت بررسی کنید. پس از ثبت و ذخیره هر آزمون، امکان بازگشت و ویرایش آن وجود ندارد.',
    },
    {
        icon: <HiOutlineVolumeOff className="w-6 h-6" />,
        color: 'emerald',
        title: 'محیط آرام و مناسب',
        description: 'آزمون را در محلی آرام و بدون حواس پرتی انجام دهید. تمرکز کافی در طول آزمون موجب افزایش کیفیت پاسخ‌های شما می‌گردد.',
    },
    {
        icon: <HiOutlineClock className="w-6 h-6" />,
        color: 'violet',
        title: 'مدیریت زمان',
        description: 'هر آزمون دارای زمان مشخصی است. زمان باقیمانده حین انجام آزمون در بالای صفحه نمایش داده می‌شود و پس از اتمام مهلت، آزمون به صورت خودکار پایان می‌یابد.',
    },
]
            ...
            <div dir="rtl" className="max-w-4xl mx-auto py-10 px-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="mb-10 text-center space-y-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
                        پیش از شروع آزمون، لطفاً موارد زیر را با دقت مطالعه فرمایید:
                    </p>
                </div>
                ...
                <div className="rounded-2xl border border-violet-200 dark:border-violet-800 bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-950/20 dark:to-purple-950/20 p-8 text-center shadow-sm max-w-2xl mx-auto">
                    ...
                    <p className="text-base text-gray-700 dark:text-gray-200 mb-6 leading-relaxed font-semibold">
                        اگر تمام موارد بالا را مطالعه کردید و شرایط لازم را دارید، می‌توانید آزمون خود را شروع کنید.
                    </p>
                    <button
